...
- [ ] **THEME-UI-010**: Category colors shall be applied as container background colors on category chips (timeline filter row) and the category edit screen color picker's palette swatches.
