...
- `docs/llds/publishing.md` — the Play Store listing copy the About positioning (slogan + "log fast / on-device first / no account required" points) must stay in sync with; also the brand-palette source
