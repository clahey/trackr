...
data class Reminder(
    ...
    val showCategoryInNotification: Boolean, // default false, per HLD "public surfaces default to discreet" tenet
...
- `docs/high-level-design.md § Tenets` — "Silence over spam," "Public surfaces default to discreet"
